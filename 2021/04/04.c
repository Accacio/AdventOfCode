...
read_board(Board * board,FILE * fp){
    ...
    while(totalNums<5*5)
    {
        if(fscanf(fp, "%d ",&number)==EOF) return(EXIT_FAILURE);
...
int verify_lines_board(Board * board)
{
    for (int i = 0; i < 5; i++) {
        int sumj=0;
        for (int j = 0; j < 5; j++) {
...
int sum_columns_board(Board * board,int column)
{
    int sumj=0;
    for (int i = 0; i < 5; i++) {
...
int sum_lines_board(Board * board,int line)
{
    int sumj=0;
    for (int i = 0; i < 5; i++) {
...
int sum_unmarked_board(Board * board)
{
    int sum=0;
    for (int i = 0; i < 25; i++) {
...
int verify_columns_board(Board * board)
{
    for (int i = 0; i < 5; i++) {
        int sumj=0;
        for (int j = 0; j < 5; j++) {
